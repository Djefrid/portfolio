        ...
        <div className="max-w-4xl mx-auto">
          ...
          <FadeInSection delay={0.1}>
            <div className="grid gap-6 sm:grid-cols-3 mb-12">
              ...
              {/* GitHub */}
              <Link href={profile.github} target="_blank" rel="noopener noreferrer" className="card text-center group">
                <div className="w-12 h-12 mx-auto mb-4 bg-primary-500/20 rounded-full flex items-center justify-center group-hover:bg-primary-500/30 transition-colors">
              ...
              {/* LinkedIn */}
              <Link href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="card text-center group">
                <div className="w-12 h-12 mx-auto mb-4 bg-primary-500/20 rounded-full flex items-center justify-center group-hover:bg-primary-500/30 transition-colors">
                  <svg className="w-6 h-6 text-primary-400" fill="currentColor" viewBox="0 0 24 24">
